...
if [ -z "${LCG_RELEASE_BASE}" ]; then
   export LCG_RELEASE_BASE=/cvmfs/atlas-nightlies.cern.ch/repo/sw/21.2/sw/lcg/releases
fi
export ROOTSYS=/cvmfs/atlas-nightlies.cern.ch/repo/sw/21.2/2020-01-10T0347/AnalysisBaseExternals/21.2.105/InstallArea/x86_64-centos7-gcc8-opt
